          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-neutral-700 text-base sm:text-lg leading-relaxed text-center mb-8">
                ...
                team. Even if you don&apos;t see a position that matches your
                skills right now, we&apos;d love to hear from you. Send us your
                resume and a brief introduction, and we&apos;ll keep you in mind
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600 text-sm mb-2">
                        Include your resume and tell us why you&apos;re
