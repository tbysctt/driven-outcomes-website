              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6 text-neutral-700">
                  <p className="text-base sm:text-lg leading-relaxed">
                    Tripod Education incursions are designed to empower
                    secondary students with engaging programs and experiences.
                    Our programs help students explore key skills like critical
                    and creative thinking, teamwork, problem solving,
                    communication skills and resilience, through hands-on
                    activities aligned with the Australian Curriculum.
                  </p>
                  <p className="text-base sm:text-lg leading-relaxed">
            ...
            <div className="container mx-auto px-4 sm:px-6">
              ...
              <ProgramsListing
                programs={programs.filter(
                  (program) => program.provider === "Tripod Education",
                )}
              />
            </div>
          </FadeInSection>
