              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10 sm:mb-12">
                  ...
                  <p className="mt-4 text-lg sm:text-xl font-semibold text-primary-brand-600">
                    Inspiring primary students with hands-on learning and
                    creativity
                  </p>
                </div>
                <div className="space-y-6 text-neutral-700">
                  <p className="text-base sm:text-lg leading-relaxed">
                    ...
                    thinking, teamwork, problem solving, communication skills
                    and resilience, through engaging activities aligned with the
