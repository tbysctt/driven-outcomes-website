              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6 text-neutral-700">
                  <p className="text-base sm:text-lg leading-relaxed">
                    ...
                    MiniBOSS primary school incursions and have been
                    specifically designed as hands-on programs that are{" "}
                    <strong className="font-semibold text-neutral-900">
                      more than just fun
                    </strong>
                    . As well as having fun, our incursions help children
                    explore key skills like critical and creative thinking,
                    curiosity, teamwork, problem solving, communication skills
                    and resilience.
                  </p>
                  <p className="text-base sm:text-lg leading-relaxed">
