...
type Skill = {
  name: string;
  icon: JSX.Element;
  colorTheme: "elementary-gold" | "amber-gold" | "thistle" | "lavender-grey";
};
...
function SkillCard({ name, icon, colorTheme }: SkillCardProps) {
  const colorClasses = {
    "elementary-gold": {
      bg: "bg-elementary-gold-500/20",
      text: "text-elementary-gold-400",
    },
    "amber-gold": {
      bg: "bg-amber-gold-500/20",
      text: "text-amber-gold-400",
    },
    thistle: {
  ...
  return (
    <div className="text-center p-4 sm:p-5 md:p-6 rounded-xl bg-amber-gold-400/10 hover:bg-amber-gold-400/20 transition-colors">
      <div
