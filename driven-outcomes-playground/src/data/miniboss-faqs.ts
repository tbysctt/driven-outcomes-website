...
export const miniBossProgramFaqs: FaqItem[] = [
  {
    question: "What are the minimum numbers for a booking?",
    answer:
      "Minimum numbers apply for all incursions. Please give us a call on 03 9415 6327 to discuss your group size and we'll help find an option that works.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our incursions are designed to help students explore critical and creative thinking, teamwork, problem solving, communication skills and resilience, through hands-on activities aligned with the Australian Curriculum.",
  },
  {
